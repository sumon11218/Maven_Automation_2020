...
public class Reusable_Methods_Reports {
    ...
    public static void click(WebDriver driver, String locator, ExtentTest logger,String elementName) throws IOException, InterruptedException {
    ...
    //********************************************************************
    //method to capture screenshot incase of failure in catch exception
